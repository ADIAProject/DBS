...
Begin VB.Form frmCheckUpdate 
   ...
   Begin prjDBS.ctlXpButton cmdExit 
      ...
      EndProperty
   End
   Begin prjDBS.ctlXpButton cmdHistory 
      Height          =   735
      Left            =   2400
      TabIndex        =   1
      Top             =   5160
      ...
      EndProperty
   End
   Begin prjDBS.ctlXpButton cmdUpdate 
      Height          =   735
      Left            =   120
      TabIndex        =   2
      Top             =   5160
   ...
   End
   Begin prjDBS.ctlLabelTVH lblWait 
      Height          =   375
      Left            =   100
      Top             =   2640
      Width           =   11160
      ...
      Alignment       =   2
   End
   Begin prjDBS.ctlLabelTVH lblVersionList 
      Height          =   375
      Left            =   120
      Top             =   450
      Width           =   4545
      ...
      ShadowStyle     =   0
   End
   Begin prjDBS.ctlLabelTVH lblWWW 
      Height          =   315
      Left            =   6120
      Top             =   450
      Width           =   5040
      ...
      Alignment       =   1
   End
   Begin prjDBS.ctlLabelTVH lblVersion 
      Height          =   315
      Left            =   120
      Top             =   45
      Width           =   11085
...
Private mboolFirstStartUpdate As Boolean
